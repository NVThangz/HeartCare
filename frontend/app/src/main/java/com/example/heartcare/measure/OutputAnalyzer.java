package com.example.heartcare.measure;
...
public class OutputAnalyzer {
    private final MeasureHeartRate activity;
    ...
    public OutputAnalyzer(MeasureHeartRate activity, TextureView graphTextureView, Handler mainHandler) {
    ...
    public void measurePulse(TextureView textureView, CameraService cameraService) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                Thread thread = new Thread(() -> {
                    ...
                    if (detectValley()) {
                        ...
                        sendMessage(MeasureHeartRate.MESSAGE_UPDATE_REALTIME, obj);
                    }
            ...
            public void onFinish() {
                ...
                if (valleys.size() == 0) {
                    mainHandler.sendMessage(Message.obtain(
                            mainHandler,
                            MeasureHeartRate.MESSAGE_CAMERA_NOT_AVAILABLE,
        ...
        activity.setViewState(MeasureHeartRate.VIEW_STATE.MEASUREMENT);
        timer.start();
    }
