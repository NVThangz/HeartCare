...
public class HealthRecordAdapter extends RecyclerView.Adapter<HealthRecordAdapter.HealthRecordViewHolder> implements Filterable {
    private List<HealthRecordItem> healthRecordList;
    private List<HealthRecordItem> healthRecordListOld;

    public HealthRecordAdapter(List<HealthRecordItem> healthRecordList) {
